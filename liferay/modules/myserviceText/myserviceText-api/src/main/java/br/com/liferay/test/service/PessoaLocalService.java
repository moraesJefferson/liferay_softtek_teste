...
/**
 * Provides the local service interface for Pessoa. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PessoaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PessoaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PessoaLocalServiceUtil} to access the pessoa local service. Add custom service methods to <code>br.com.liferay.test.service.impl.PessoaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
